...
public class BasicStoreTools extends BasicStoreToolsBase {
	...
	public void setSendStrategy(Context paramContext, int paramInt) {
		putInt(paramContext, "sendStrategy", paramInt);
	}

	public int getSendStrategy(Context paramContext) {
		return getInt(paramContext, "sendStrategy", -1);
	}

	public void setSendStrategyTime(Context paramContext, long paramLong) {
		putLong(paramContext, "timeinterval", paramLong);
	}

	public long getSendStrategyTime(Context paramContext) {
		return getLong(paramContext, "timeinterval", 1L);
	}
