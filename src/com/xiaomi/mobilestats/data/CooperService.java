...
public class CooperService extends BasicStoreToolsBase{
	...
	public static String getMacID(Context context)
	  ...
	  {
		  if(TextUtils.isEmpty(mobileInfo.deviceId)) mobileInfo.deviceId = CommonUtil.getDeviceID(paramContext);
	  ...
	  public static String getAppChannel(Context paramContext)
	  {
	    try
	    {
	      if (TextUtils.isEmpty(mobileInfo.appChannel))
	      {
	        ...
	        if ((!bool) ||(TextUtils.isEmpty(mobileInfo.appChannel)))
	          //从配置文件中读取appChannel
	          mobileInfo.appChannel = "";
	      }
